...
// Store io instance in app to make it accessible to routes/controllers if needed, 
// but we will also export it.
app.set("io", io);

io.on("connection", (socket) => {
  console.log("New client connected: " + socket.id);

  // Setup basic socket rooms for real-time notifications
